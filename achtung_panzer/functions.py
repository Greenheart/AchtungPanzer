...
def detect_collision(obj1, obj2):
	if obj1.type == 1: #If the object is an area object
		for circle in obj1.circles:
			...
			distance = math.sqrt((math.fabs(float(circle.x - obj2.x)))**2 + (math.fabs(float(circle.y - obj2.y)))**2 )
		...
		for circle in obj2.circles:
			...
			distance = math.sqrt((math.fabs(float(circle.x - obj1.x)))**2 + (math.fabs(float(circle.y - obj1.y)))**2 )
		...
		distance = math.sqrt((math.fabs(float(obj1.x - obj2.x)))**2 + (math.fabs(float(obj1.y - obj2.y)))**2 )
